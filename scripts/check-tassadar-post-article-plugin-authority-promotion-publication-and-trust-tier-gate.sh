...
cargo test -p psionic-catalog --lib post_article_plugin_authority_gate_ -- --nocapture
cargo test -p psionic-research --lib post_article_plugin_authority_gate_summary_ -- --nocapture
cargo test -p psionic-provider --lib post_article_plugin_authority_promotion_publication_trust_tier_receipt_projects_summary -- --nocapture
