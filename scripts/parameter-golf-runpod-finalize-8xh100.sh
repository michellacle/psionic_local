...
distributed_completion_receipt_path="${submission_dir}/parameter-golf-distributed-8xh100-run/benchmark/parameter_golf_distributed_8xh100_completion.json"
...
distributed_completion_receipt_path = Path(sys.argv[19])
...
report = {
    ...
    "exported_folder_evidence": {
      ...
      "distributed_completion_receipt_path": str(distributed_completion_receipt_path) if distributed_completion_receipt_path.exists() else None,
      "distributed_completion_receipt_sha256": sha256(distributed_completion_receipt_path),
