...
const LOOKUP_BASELINE_SOURCE_RUN_BUNDLE: &str = "fixtures/tassadar/runs/sudoku_v0_trainable_surface_ablation_v1/output_head_embeddings_and_small_learned_mixer/run_bundle.json";
const LOOKUP_BASELINE_PRESERVED_FAMILY_REPORT: &str = "fixtures/tassadar/runs/sudoku_v0_architecture_comparison_v1/lookup_baseline/family_report.json";
const LOOKUP_BASELINE_PRESERVED_MODEL_DESCRIPTOR: &str = "fixtures/tassadar/runs/sudoku_v0_architecture_comparison_v1/lookup_baseline/model_descriptor.json";
const TRAINED_ATTENTION_CHECKPOINT_STATE: &str =
    "fixtures/tassadar/runs/sudoku_v0_attention_training_v1/checkpoint_state.json";
const TRAINED_ATTENTION_SOURCE_RUN_BUNDLE: &str =
    "fixtures/tassadar/runs/sudoku_v0_attention_training_v1/run_bundle.json";
