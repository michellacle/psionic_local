...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let report_path = tassadar_rust_only_article_closeout_summary_report_path();
    let report = write_tassadar_rust_only_article_closeout_summary_report(&report_path)?;
